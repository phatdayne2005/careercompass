...
|---|---|---|---|
| `target/site/jacoco/` | **Toàn bộ** — gộp cả hai bên | **98,7%** | **94,8%** |
| `target/site/jacoco-whitebox/` | Chỉ test hộp trắng | 98,7% | 94,0% |
| `target/site/jacoco-blackbox/` | Chỉ test hộp đen | 7,9% | 12,2% |
...
> quy tắc. Không loại thì con số là 92,8% / 89,2%; 138 dòng gieo dữ liệu kéo tụt gần sáu
...
| Toàn bộ + bao phủ gộp | `./mvnw clean test` | 572 test · 98,7% · 94,8% |
| Bao phủ riêng hộp trắng / hộp đen | `target/site/jacoco-whitebox/` · `jacoco-blackbox/` | 98,7% / 7,9% dòng |
