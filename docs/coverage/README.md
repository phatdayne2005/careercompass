...
|---|---|---|---|
| Dòng lệnh (Line) | 60,1% | **98,7%** | +38,6 |
| Nhánh (Branch) | 48,2% | **94,8%** | +46,6 |
| Độ phức tạp được phủ | 53,4% | **93,8%** | +40,4 |
| Phương thức | 65,1% | **96,9%** | +31,8 |
| Lớp | 75,4% | **98,4%** | +23,0 |
...
Vậy mà bao phủ nhánh tăng hơn 46 điểm phần trăm. Điều này cho thấy kỹ thuật hộp đen có
giá trị thực chất, không chỉ là bài tập vẽ bảng.

Nhưng vẫn còn **5,2% nhánh chưa chạm** — đúng như slide 51 của chương IV:
